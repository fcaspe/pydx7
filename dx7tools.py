...
def get_modmatrix(algorithm):
    modmatrix = np.zeros([6,6])
    modmatrix[0,:] = np.array([0,1,0,0,0,0])
    modmatrix[1,:] = np.array([0,0,0,0,0,0])
    modmatrix[2,:] = np.array([0,0,0,1,0,0])
    modmatrix[3,:] = np.array([0,0,0,0,0,0])
    modmatrix[4,:] = np.array([0,0,0,0,0,1])
    modmatrix[5,:] = np.array([0,0,0,0,0,0])
    return modmatrix
